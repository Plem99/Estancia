...
public class ControlX10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_control_x10);

        /*AdminSQLiteOpenHelper adminB = new AdminSQLiteOpenHelper(this, "administracion",null,1);
        SQLiteDatabase BDD = adminB.getWritableDatabase();

        Cursor fila = BDD.rawQuery("select ip from direccion where id = 1",null);
        ADDRESS = fila.getString(0);
        BDD.close();*/
        ...
        on1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "1 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "9 on");
                }
        ...
        on2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "2 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "10 on");
                }
        ...
        on3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "3 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "11 on");
                }
        ...
        on4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "4 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "12 on");
                }
        ...
        on5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "5 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "13 on");
                }
        ...
        on6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "6 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "14 on");
                }
        ...
        on7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "7 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "15 on");
                }
        ...
        on8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "8 on");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "16 on");
                }
        ...
        off1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "1 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "9 off");
                }
        ...
        off2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "2 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "10 off");
                }
        ...
        off3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "3 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "11 off");
                }
        ...
        off4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "4 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "12 off");
                }
        ...
        off5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "5 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "13 off");
                }
        ...
        off6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "6 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "14 off");
                }
        ...
        off7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "7 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "15 off");
                }
        ...
        off8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bandera == 1) {
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "8 off");
                }else
                if(bandera==2){
                    ControlX10.MyATaskCliente myATaskYW = new ControlX10.MyATaskCliente();
                    texto = spinner1.getSelectedItem().toString();
                    myATaskYW.execute("pl " + texto + "16 off");
                }
